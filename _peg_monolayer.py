...
# peg_polymer = PegPolymer()
# peg_polymer.visualize()
...
# peg_polymer_silane = PegPolymerSilane(10)
# peg_polymer_silane.visualize()
...
mask = grid_mask_2d(7, 7)
peg_monolayer = PegMonolayer(chain_length=3, mask=mask, tile_y=1, tile_x=1)
peg_monolayer.visualize()
# peg_monolayer.view_hierarchy()

# for atom in peg_monolayer.yield_atoms():
#     if atom.name != 'G':
#         print(atom.name)

# traj = peg_monolayer.to_trajectory()
# peg_monolayer.save_gromacs('peg_monolayer.gro', traj)
# peg_monolayer.visualize()
